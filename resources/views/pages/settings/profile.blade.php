...
new #[Title('Configuracion de perfil')] class extends Component {
...
<section class="w-full">
    ...
    <x-pages::settings.layout :heading="__('Perfil')" :subheading="__('Actualiza tu nombre y correo de acceso')">
                ...
                @if ($this->hasUnverifiedEmail)
                    <div>
                        <flux:text class="mt-4">
                            {{ __('Tu correo aun no esta verificado.') }}
                        ...
                        @if (session('status') === 'verification-link-sent')
                            <flux:text class="mt-2 font-medium !dark:text-green-400 !text-green-600">
                                {{ __('Se envio un nuevo enlace de verificacion.') }}
                            </flux:text>
                        @endif
                    </div>
                @endif

...
<body>
    ...
    <section class="hero-produccion">
        <div class="hero-produccion__overlay"></div>

        <div class="hero-produccion__content">
            <span class="hero-badge">Indicadores Hospitalarios</span>

            <h2>Indicador de Producción y Rendimiento</h2>

            <p>
                Visualiza los indicadores principales del área de producción y rendimiento.
            </p>
        </div>
    </section>
    ...
    <main class="contenedor">
        ...
        <section class="seccion-titulo">
            <span class="section-tag">Sección A</span>

            <h3>Indicadores de Producción y Rendimiento</h3>

            <p>
                Esta sección muestra los indicadores de desempeño hospitalario relacionados con
                producción y rendimiento del servicio médico.
            </p>
        </section>
        ...
        <section class="grafica-panel">
            <div class="grafica-header">
                <h4>Gráfica de Producción y Rendimiento</h4>
                <p>Visualización comparativa de Enero, Febrero y Total Anual por indicador.</p>
            </div>
    ...
    <footer class="footer">
        © <span id="year"></span> Hospital San José - Producción y Rendimiento
    </footer>
